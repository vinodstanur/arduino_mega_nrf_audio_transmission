...
#define nrf24l01_CE_IOREGISTER		PORTL
#define nrf24l01_CE_PINMASK			(1<<PL1)
#define ce_low PORTL &= ~(1<<PL1);
#define ce_high PORTL |= (1<<PL1);///////PIN 48 ARDUINO MEGA
//defines for uC pins CSN pin is connected to
//This is used so that the routines can send properly operate the SPI interface
// on the nrf24l01.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_CSN_IOREGISTER		PORTL //PIN 53 SS ARDUINO MEGA
#define nrf24l01_CSN_PINMASK		(1<<PL0)
#define csn_low PORTL &= ~(1<<PL0);
#define csn_high PORTL |= (1<<PL0);

//defines for uC pins IRQ pin is connected to
//This is used so that the routines can poll for IRQ or create an ISR.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_IRQ_IOREGISTER		PIND
#define nrf24l01_IRQ_PINMASK		(1<<PD0)
...
#define nrf24l01_RF_CH_DEFAULT_VAL			0x07
